...
shaka.media.SegmentedTextStream.prototype.hasEnded = function() {
  shaka.log.debug('Webvtt/mp4: Cannot determine ending SegmentedTextStream',
 ...
 * @return {boolean} true if the stream is buffered.
 */
shaka.media.SegmentedTextStream.prototype.isBuffered =
    function(time) {
