...
shaka.player.DashVideoSource =
  ...
  /** @protected {?shaka.player.DashVideoSource.ContentProtectionCallback} */
  ...
  /** @protected {shaka.util.FailoverUri.NetworkCallback} */
  this.networkCallback_ = null;

  /** @private {Function} */
  this.mpdPostProcessor_ = null;
};
...
shaka.player.DashVideoSource.prototype.load = function() {
  ...
  return mpdRequest
    .mpdPostProcessor(this.mpdPostProcessor_)
    .send()
...
/**
 * Sets a override method for the mpd file
 *
 * @export
 * @param {Function} mpdPostProcessor
 */
shaka.player.DashVideoSource.prototype.postProcessMpd =
    function(mpdPostProcessor) {
  this.mpdPostProcessor_ = mpdPostProcessor;
};
  ...
  shaka.player.DashVideoSource.prototype.onUpdateManifest = function(url) {
    ...
    return mpdRequest
      ...
      .then(shaka.util.TypedBind(this,
        /** @param {!shaka.dash.mpd.Mpd} mpd */
        function(mpd) {
          if (typeof this.mpdPostProcessor_ === 'function') {
            mpd = this.mpdPostProcessor_(mpd) || mpd;
          }
          var mpdProcessor =
              new shaka.dash.MpdProcessor(this.interpretContentProtection_);
          var newManifestInfo =
