...
shaka.dash.DashParser.prototype.parseAdaptationSet_ = function(context, elem) {
  ...
  roleValues = shaka.util.MagineUtils.modifyIfAccessibTag_(roleValues, elem);
...
shaka.dash.DashParser.prototype.parseRepresentation_ = function(
  ...
  roles = shaka.util.MagineUtils.modifyIfAccessibTag_(roles, node);
  ...
  var hasAccessibility = shaka.util.MagineUtils.hasAccessibTag_(node);
  if (hasAccessibility) {
    language = shaka.util.MagineUtils.returnAccessibLang_(language);
  }
