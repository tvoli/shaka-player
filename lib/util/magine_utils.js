 ...
 * @private
 */
shaka.util.MagineUtils.prototype.returnAccessibLang_ = function(language) {
 ...
 * @private
 */
shaka.util.MagineUtils.prototype.hasAccessibTag_ = function(elem) {
 ...
 * @private
 */
shaka.util.MagineUtils.prototype.modifyIfAccessibTag_ =
    function(roles, elem) {
  var XmlUtils = shaka.util.XmlUtils,
      accessbilityElems = XmlUtils.findChildren(elem, 'Accessibility'),
      modifiedRoles = roles,
