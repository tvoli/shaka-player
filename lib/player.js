...
shaka.Player.prototype.getAudioLanguages = function() {
  ...
  // Modify variants with audio language from audio tracks
  // Magine descriptive audio FIX - POC
  variants = shaka.util.MagineUtils.modifyVariantsWithAudioLanguage(variants);
